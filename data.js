...
const FOOTER_BLURB =
  "Cloud & DevOps engineer based in Cairo — currently a DevOps intern at DEPI and a " +
  "Computer Engineering student at Monufia University. I build and deploy applications " +
  "on AWS and Huawei Cloud, and automate the infrastructure around them with Docker, " +
  "Kubernetes, Terraform and Ansible. Open to internships, freelance work and " +
  "entry-level cloud roles.";

/**
 * Platform links shown as icons in the footer.
 * >>> PASTE YOUR REAL PROFILE URLS IN THE `url` FIELDS BELOW. <<<
 * Any entry whose url is still "#" is hidden automatically, so the footer
 * never shows a dead link.
 */
const SOCIALS = [
  { key: "mostaql",  label: "Mostaql",  url: "https://mostaql.com/u/AsemAzab" }, 
  { key: "khamsat",  label: "Khamsat",  url: "https://khamsat.com/user/asemazab" }, // TODO: https://khamsat.com/user/...
  { key: "upwork",   label: "Upwork",   url: "https://www.upwork.com/freelancers/~01fc36c20f9e755528" }, // TODO: https://www.upwork.com/freelancers/...
  { key: "linkedin", label: "LinkedIn", url: "www.linkedin.com/in/assem-mohamed206" }, // TODO: https://www.linkedin.com/in/...
  { key: "github",   label: "GitHub",   url: "https://github.com/assemazab/Asem-profile" }, // TODO: https://github.com/...
];
